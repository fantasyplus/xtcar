 ...
 */
void convertWaypointsToMPCTraj(const mpc_msgs::Lane &path, MPCTrajectory &mpc_traj);
 ...
 */
void convertWaypointsToMPCTrajWithResample(const mpc_msgs::Lane &path, const std::vector<double> &path_time,
 ...
 * @param [out] ref_traj converted reference trajectory
 */
void convertWaypointsToMPCTrajWithDistanceResample(const mpc_msgs::Lane &path, const std::vector<double> &path_time,
 ...
 * @param [out] ref_traj converted reference trajectory
 */
void convertWaypointsToMPCTrajWithTimeResample(const mpc_msgs::Lane &path, const std::vector<double> &path_time,
 ...
 */
void calcPathRelativeTime(const mpc_msgs::Lane &path, std::vector<double> &path_time);
