...
void MPCUtils::convertWaypointsToMPCTraj(const mpc_msgs::Lane &lane, MPCTrajectory &mpc_traj)
{
  mpc_traj.clear();
...
void MPCUtils::convertWaypointsToMPCTrajWithDistanceResample(const mpc_msgs::Lane &path, const std::vector<double> &path_time,
...
void MPCUtils::convertWaypointsToMPCTrajWithTimeResample(const mpc_msgs::Lane &path, const std::vector<double> &path_time,
...
void MPCUtils::convertWaypointsToMPCTrajWithResample(const mpc_msgs::Lane &path, const std::vector<double> &path_time,
...
void MPCUtils::calcPathRelativeTime(const mpc_msgs::Lane &path, std::vector<double> &path_time)
{
  double t = 0.0;
  path_time.clear();
