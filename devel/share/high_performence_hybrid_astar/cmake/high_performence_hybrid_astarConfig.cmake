...
if(high_performence_hybrid_astar_CONFIG_INCLUDED)
  return()
endif()
set(high_performence_hybrid_astar_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(high_performence_hybrid_astar_SOURCE_PREFIX /home/ros/fantasyplus/xtcar/src/high_performence_hybrid_astar)
  set(high_performence_hybrid_astar_DEVEL_PREFIX /home/ros/fantasyplus/xtcar/devel)
  set(high_performence_hybrid_astar_INSTALL_PREFIX "")
  set(high_performence_hybrid_astar_PREFIX ${high_performence_hybrid_astar_DEVEL_PREFIX})
else()
  set(high_performence_hybrid_astar_SOURCE_PREFIX "")
  set(high_performence_hybrid_astar_DEVEL_PREFIX "")
  set(high_performence_hybrid_astar_INSTALL_PREFIX /home/ros/fantasyplus/xtcar/install)
  set(high_performence_hybrid_astar_PREFIX ${high_performence_hybrid_astar_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'high_performence_hybrid_astar' is deprecated")
...
set(high_performence_hybrid_astar_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/ros/fantasyplus/xtcar/src/high_performence_hybrid_astar/include " STREQUAL " ")
  set(high_performence_hybrid_astar_INCLUDE_DIRS "")
  set(_include_dirs "/home/ros/fantasyplus/xtcar/src/high_performence_hybrid_astar/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${high_performence_hybrid_astar_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'high_performence_hybrid_astar' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'high_performence_hybrid_astar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/fantasyplus/xtcar/src/high_performence_hybrid_astar/${idir}'.  ${_report}")
    endif()
    _list_append_unique(high_performence_hybrid_astar_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "high_performence_hybrid_astar")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND high_performence_hybrid_astar_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND high_performence_hybrid_astar_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT high_performence_hybrid_astar_NUM_DUMMY_TARGETS)
      set(high_performence_hybrid_astar_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::high_performence_hybrid_astar::wrapped-linker-option${high_performence_hybrid_astar_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR high_performence_hybrid_astar_NUM_DUMMY_TARGETS "${high_performence_hybrid_astar_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::high_performence_hybrid_astar::wrapped-linker-option${high_performence_hybrid_astar_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND high_performence_hybrid_astar_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(high_performence_hybrid_astar_LIBRARY_DIRS ${lib_path})
      list(APPEND high_performence_hybrid_astar_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'high_performence_hybrid_astar'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND high_performence_hybrid_astar_LIBRARIES ${lib})
    endif()
  endif()
...
set(high_performence_hybrid_astar_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${high_performence_hybrid_astar_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 high_performence_hybrid_astar_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${high_performence_hybrid_astar_dep}_FOUND)
      find_package(${high_performence_hybrid_astar_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${high_performence_hybrid_astar_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(high_performence_hybrid_astar_INCLUDE_DIRS ${${high_performence_hybrid_astar_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(high_performence_hybrid_astar_LIBRARIES ${high_performence_hybrid_astar_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${high_performence_hybrid_astar_dep}_LIBRARIES})
  _list_append_deduplicate(high_performence_hybrid_astar_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(high_performence_hybrid_astar_LIBRARIES ${high_performence_hybrid_astar_LIBRARIES})

  _list_append_unique(high_performence_hybrid_astar_LIBRARY_DIRS ${${high_performence_hybrid_astar_dep}_LIBRARY_DIRS})
  list(APPEND high_performence_hybrid_astar_EXPORTED_TARGETS ${${high_performence_hybrid_astar_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${high_performence_hybrid_astar_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
