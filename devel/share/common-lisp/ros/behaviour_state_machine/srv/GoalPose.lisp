...
(cl:defmethod traj-val ((m <GoalPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader behaviour_state_machine-srv:traj-val is deprecated.  Use behaviour_state_machine-srv:traj instead.")
  (traj m))
