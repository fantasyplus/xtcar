...
if(car_tf_broadcaster_xt_CONFIG_INCLUDED)
  return()
endif()
set(car_tf_broadcaster_xt_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(car_tf_broadcaster_xt_SOURCE_PREFIX /home/ros/fantasyplus/xtcar/src/car_tf_broadcaster)
  set(car_tf_broadcaster_xt_DEVEL_PREFIX /home/ros/fantasyplus/xtcar/devel)
  set(car_tf_broadcaster_xt_INSTALL_PREFIX "")
  set(car_tf_broadcaster_xt_PREFIX ${car_tf_broadcaster_xt_DEVEL_PREFIX})
else()
  set(car_tf_broadcaster_xt_SOURCE_PREFIX "")
  set(car_tf_broadcaster_xt_DEVEL_PREFIX "")
  set(car_tf_broadcaster_xt_INSTALL_PREFIX /home/ros/fantasyplus/xtcar/install)
  set(car_tf_broadcaster_xt_PREFIX ${car_tf_broadcaster_xt_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'car_tf_broadcaster_xt' is deprecated")
...
set(car_tf_broadcaster_xt_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(car_tf_broadcaster_xt_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${car_tf_broadcaster_xt_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'car_tf_broadcaster_xt' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'car_tf_broadcaster_xt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/fantasyplus/xtcar/src/car_tf_broadcaster/${idir}'.  ${_report}")
    endif()
    _list_append_unique(car_tf_broadcaster_xt_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND car_tf_broadcaster_xt_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND car_tf_broadcaster_xt_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT car_tf_broadcaster_xt_NUM_DUMMY_TARGETS)
      set(car_tf_broadcaster_xt_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::car_tf_broadcaster_xt::wrapped-linker-option${car_tf_broadcaster_xt_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR car_tf_broadcaster_xt_NUM_DUMMY_TARGETS "${car_tf_broadcaster_xt_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::car_tf_broadcaster_xt::wrapped-linker-option${car_tf_broadcaster_xt_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND car_tf_broadcaster_xt_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(car_tf_broadcaster_xt_LIBRARY_DIRS ${lib_path})
      list(APPEND car_tf_broadcaster_xt_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'car_tf_broadcaster_xt'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND car_tf_broadcaster_xt_LIBRARIES ${lib})
    endif()
  endif()
...
set(car_tf_broadcaster_xt_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${car_tf_broadcaster_xt_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 car_tf_broadcaster_xt_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${car_tf_broadcaster_xt_dep}_FOUND)
      find_package(${car_tf_broadcaster_xt_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${car_tf_broadcaster_xt_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(car_tf_broadcaster_xt_INCLUDE_DIRS ${${car_tf_broadcaster_xt_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(car_tf_broadcaster_xt_LIBRARIES ${car_tf_broadcaster_xt_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${car_tf_broadcaster_xt_dep}_LIBRARIES})
  _list_append_deduplicate(car_tf_broadcaster_xt_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(car_tf_broadcaster_xt_LIBRARIES ${car_tf_broadcaster_xt_LIBRARIES})

  _list_append_unique(car_tf_broadcaster_xt_LIBRARY_DIRS ${${car_tf_broadcaster_xt_dep}_LIBRARY_DIRS})
  list(APPEND car_tf_broadcaster_xt_EXPORTED_TARGETS ${${car_tf_broadcaster_xt_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${car_tf_broadcaster_xt_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
