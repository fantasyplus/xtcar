...
if("TRUE" STREQUAL "TRUE")
  set(grid_map_SOURCE_PREFIX /home/ros/fantasyplus/xtcar/src/grid_map)
  set(grid_map_DEVEL_PREFIX /home/ros/fantasyplus/xtcar/devel)
  set(grid_map_INSTALL_PREFIX "")
  set(grid_map_PREFIX ${grid_map_DEVEL_PREFIX})
else()
  set(grid_map_SOURCE_PREFIX "")
  set(grid_map_DEVEL_PREFIX "")
  set(grid_map_INSTALL_PREFIX /home/ros/fantasyplus/xtcar/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'vivwimp <vivwimp@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'grid_map' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/fantasyplus/xtcar/src/grid_map/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT grid_map_NUM_DUMMY_TARGETS)
      set(grid_map_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::grid_map::wrapped-linker-option${grid_map_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR grid_map_NUM_DUMMY_TARGETS "${grid_map_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::grid_map::wrapped-linker-option${grid_map_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND grid_map_LIBRARIES "${interface_target_name}")
