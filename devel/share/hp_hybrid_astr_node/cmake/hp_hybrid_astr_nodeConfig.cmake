...
if(hp_hybrid_astr_node_CONFIG_INCLUDED)
  return()
endif()
set(hp_hybrid_astr_node_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(hp_hybrid_astr_node_SOURCE_PREFIX /home/ros/fantasyplus/xtcar/src/hp_hybrid_astr_node)
  set(hp_hybrid_astr_node_DEVEL_PREFIX /home/ros/fantasyplus/xtcar/devel)
  set(hp_hybrid_astr_node_INSTALL_PREFIX "")
  set(hp_hybrid_astr_node_PREFIX ${hp_hybrid_astr_node_DEVEL_PREFIX})
else()
  set(hp_hybrid_astr_node_SOURCE_PREFIX "")
  set(hp_hybrid_astr_node_DEVEL_PREFIX "")
  set(hp_hybrid_astr_node_INSTALL_PREFIX /home/ros/fantasyplus/xtcar/install)
  set(hp_hybrid_astr_node_PREFIX ${hp_hybrid_astr_node_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'hp_hybrid_astr_node' is deprecated")
...
set(hp_hybrid_astr_node_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(hp_hybrid_astr_node_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${hp_hybrid_astr_node_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hp_hybrid_astr_node' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'hp_hybrid_astr_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/fantasyplus/xtcar/src/hp_hybrid_astr_node/${idir}'.  ${_report}")
    endif()
    _list_append_unique(hp_hybrid_astr_node_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND hp_hybrid_astr_node_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND hp_hybrid_astr_node_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT hp_hybrid_astr_node_NUM_DUMMY_TARGETS)
      set(hp_hybrid_astr_node_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::hp_hybrid_astr_node::wrapped-linker-option${hp_hybrid_astr_node_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR hp_hybrid_astr_node_NUM_DUMMY_TARGETS "${hp_hybrid_astr_node_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::hp_hybrid_astr_node::wrapped-linker-option${hp_hybrid_astr_node_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND hp_hybrid_astr_node_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(hp_hybrid_astr_node_LIBRARY_DIRS ${lib_path})
      list(APPEND hp_hybrid_astr_node_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'hp_hybrid_astr_node'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND hp_hybrid_astr_node_LIBRARIES ${lib})
    endif()
  endif()
...
set(hp_hybrid_astr_node_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${hp_hybrid_astr_node_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 hp_hybrid_astr_node_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${hp_hybrid_astr_node_dep}_FOUND)
      find_package(${hp_hybrid_astr_node_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hp_hybrid_astr_node_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(hp_hybrid_astr_node_INCLUDE_DIRS ${${hp_hybrid_astr_node_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(hp_hybrid_astr_node_LIBRARIES ${hp_hybrid_astr_node_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${hp_hybrid_astr_node_dep}_LIBRARIES})
  _list_append_deduplicate(hp_hybrid_astr_node_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(hp_hybrid_astr_node_LIBRARIES ${hp_hybrid_astr_node_LIBRARIES})

  _list_append_unique(hp_hybrid_astr_node_LIBRARY_DIRS ${${hp_hybrid_astr_node_dep}_LIBRARY_DIRS})
  list(APPEND hp_hybrid_astr_node_EXPORTED_TARGETS ${${hp_hybrid_astr_node_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${hp_hybrid_astr_node_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
