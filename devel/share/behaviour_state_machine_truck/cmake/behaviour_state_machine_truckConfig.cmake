...
if(behaviour_state_machine_truck_CONFIG_INCLUDED)
  return()
endif()
set(behaviour_state_machine_truck_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(behaviour_state_machine_truck_SOURCE_PREFIX /home/ros/fantasyplus/xtcar/src/behaviour_state_machine_truck)
  set(behaviour_state_machine_truck_DEVEL_PREFIX /home/ros/fantasyplus/xtcar/devel)
  set(behaviour_state_machine_truck_INSTALL_PREFIX "")
  set(behaviour_state_machine_truck_PREFIX ${behaviour_state_machine_truck_DEVEL_PREFIX})
else()
  set(behaviour_state_machine_truck_SOURCE_PREFIX "")
  set(behaviour_state_machine_truck_DEVEL_PREFIX "")
  set(behaviour_state_machine_truck_INSTALL_PREFIX /home/ros/fantasyplus/xtcar/install)
  set(behaviour_state_machine_truck_PREFIX ${behaviour_state_machine_truck_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'behaviour_state_machine_truck' is deprecated")
...
set(behaviour_state_machine_truck_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/ros/fantasyplus/xtcar/devel/include " STREQUAL " ")
  set(behaviour_state_machine_truck_INCLUDE_DIRS "")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'fantasyplus <530925206@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${behaviour_state_machine_truck_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'behaviour_state_machine_truck' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'behaviour_state_machine_truck' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/fantasyplus/xtcar/src/behaviour_state_machine_truck/${idir}'.  ${_report}")
    endif()
    _list_append_unique(behaviour_state_machine_truck_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND behaviour_state_machine_truck_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND behaviour_state_machine_truck_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT behaviour_state_machine_truck_NUM_DUMMY_TARGETS)
      set(behaviour_state_machine_truck_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::behaviour_state_machine_truck::wrapped-linker-option${behaviour_state_machine_truck_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR behaviour_state_machine_truck_NUM_DUMMY_TARGETS "${behaviour_state_machine_truck_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::behaviour_state_machine_truck::wrapped-linker-option${behaviour_state_machine_truck_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND behaviour_state_machine_truck_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(behaviour_state_machine_truck_LIBRARY_DIRS ${lib_path})
      list(APPEND behaviour_state_machine_truck_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'behaviour_state_machine_truck'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND behaviour_state_machine_truck_LIBRARIES ${lib})
    endif()
  endif()
...
set(behaviour_state_machine_truck_EXPORTED_TARGETS "behaviour_state_machine_truck_generate_messages_cpp;behaviour_state_machine_truck_generate_messages_eus;behaviour_state_machine_truck_generate_messages_lisp;behaviour_state_machine_truck_generate_messages_nodejs;behaviour_state_machine_truck_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${behaviour_state_machine_truck_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 behaviour_state_machine_truck_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${behaviour_state_machine_truck_dep}_FOUND)
      find_package(${behaviour_state_machine_truck_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${behaviour_state_machine_truck_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(behaviour_state_machine_truck_INCLUDE_DIRS ${${behaviour_state_machine_truck_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(behaviour_state_machine_truck_LIBRARIES ${behaviour_state_machine_truck_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${behaviour_state_machine_truck_dep}_LIBRARIES})
  _list_append_deduplicate(behaviour_state_machine_truck_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(behaviour_state_machine_truck_LIBRARIES ${behaviour_state_machine_truck_LIBRARIES})

  _list_append_unique(behaviour_state_machine_truck_LIBRARY_DIRS ${${behaviour_state_machine_truck_dep}_LIBRARY_DIRS})
  list(APPEND behaviour_state_machine_truck_EXPORTED_TARGETS ${${behaviour_state_machine_truck_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "behaviour_state_machine_truck-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${behaviour_state_machine_truck_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
